...
class response_msg {
    ...
    private static final GroupLayout flash_begin$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$123:5"), groupElement("flash_begin"));
    ...
    private static final GroupLayout flash_data$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$123:5"), groupElement("flash_data"));
    ...
    private static final GroupLayout flash_data_end$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$123:5"), groupElement("flash_data_end"));
    ...
    private static final GroupLayout configure_shutdown$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$123:5"), groupElement("configure_shutdown"));
    ...
    private static final GroupLayout configure_engagement$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$123:5"), groupElement("configure_engagement"));
    ...
    private static final GroupLayout scan$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$123:5"), groupElement("scan"));
    ...
    private static final GroupLayout info_and_state$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$123:5"), groupElement("info_and_state"));
    ...
    private static final GroupLayout set_node_info$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$123:5"), groupElement("set_node_info"));
