...
class device_info {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(4, node_info.layout()).withName("nodes")
    ...
    public static void nodes(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, nodes(struct, index0), 0L, node_info.layout().byteSize());
    }
