...
class device_configuration {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(4, device_configuration.nodes.layout()).withName("nodes")
    ).withName("device_configuration");
    ...
    public static class nodes {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            node_spi_config.layout().withName("spi_config"),
    ...
    public static void nodes(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, nodes(struct, index0), 0L, device_configuration.nodes.layout().byteSize());
    }
